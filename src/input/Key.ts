 ...
 */
export class Key {
    private static _Enter = (element: Detox.NativeElement) => element.tapReturnKey()
    public static Enter = new Key('Enter', Key._Enter);
    ...
    constructor(
        ...
        public readonly fn: (element: Detox.NativeElement) => Promise<void>,
    ) {
    }
